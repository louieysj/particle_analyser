...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_current_folder.setGeometry(QtCore.QRect(120, 40, 261, 16))
        ...
        self.label.setGeometry(QtCore.QRect(23, 40, 90, 16))
        self.label.setObjectName("label")
        self.label_current_file = QtWidgets.QLabel(self.groupBox)
        self.label_current_file.setGeometry(QtCore.QRect(120, 64, 261, 17))
        self.label_current_file.setText("")
        self.label_current_file.setObjectName("label_current_file")
        self.label_3 = QtWidgets.QLabel(self.groupBox)
        self.label_3.setGeometry(QtCore.QRect(23, 64, 90, 16))
        self.label_3.setObjectName("label_3")
        self.groupBox_3 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_3.setGeometry(QtCore.QRect(10, 130, 601, 151))
        ...
        self.label_actual_scale.setGeometry(QtCore.QRect(10, 50, 251, 16))
        self.label_actual_scale.setObjectName("label_actual_scale")
        self.label_minmaxDepth = QtWidgets.QLabel(self.groupBox_3)
        self.label_minmaxDepth.setGeometry(QtCore.QRect(10, 80, 581, 21))
        self.label_minmaxDepth.setObjectName("label_minmaxDepth")
        self.slider_depth = QtWidgets.QSlider(self.groupBox_3)
        self.slider_depth.setGeometry(QtCore.QRect(10, 110, 581, 21))
        self.slider_depth.setMaximum(1000)
        self.slider_depth.setSingleStep(5)
        self.slider_depth.setPageStep(5)
        self.slider_depth.setProperty("value", 25)
        self.slider_depth.setOrientation(QtCore.Qt.Horizontal)
        self.slider_depth.setObjectName("slider_depth")
        self.groupBox_4 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_4.setGeometry(QtCore.QRect(630, 20, 361, 181))
        self.groupBox_4.setObjectName("groupBox_4")
        self.label_minmaxArea = QtWidgets.QLabel(self.groupBox_4)
        self.label_minmaxArea.setGeometry(QtCore.QRect(20, 50, 301, 31))
        ...
        self.checkBox_delete_edge_contour.setGeometry(QtCore.QRect(20, 140, 151, 19))
        ...
        self.slider_area.setGeometry(QtCore.QRect(20, 90, 321, 21))
        self.slider_area.setMaximum(1000)
        self.slider_area.setSingleStep(5)
        self.slider_area.setPageStep(5)
        ...
        self.checkBox_draw_contours.setGeometry(QtCore.QRect(20, 20, 91, 21))
        self.checkBox_draw_contours.setChecked(True)
        self.checkBox_draw_contours.setObjectName("checkBox_draw_contours")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(790, 220, 161, 31))
        font = QtGui.QFont()
        ...
        self.actionPreprocessDepth = QtWidgets.QAction(MainWindow)
        self.actionPreprocessDepth.setObjectName("actionPreprocessDepth")
        ...
        self.menuTool.addSeparator()
        self.menuTool.addAction(self.actionPreprocessDepth)
        self.menubar.addAction(self.menuFile.menuAction())
        self.menubar.addAction(self.menuTool.menuAction())
        self.toolBar.addAction(self.actionOpenFolder)
        self.toolBar_2.addAction(self.actionPreprocessDepth)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Detector-OpenCV"))
        ...
        self.label_minmaxDepth.setText(_translate("MainWindow", "DepthFilter"))
        ...
        self.actionPreprocessDepth.setText(_translate("MainWindow", "PreprocessDepth"))
